...
<p align="center">
  <img src="doc/01_basic_cantilever-transparent.png" width="80%" alt="Gripper topology optimization result" />
</p>
...
pkg> add https://github.com/yourusername/EasySIMP.jl
```

or

```bash
git clone https://github.com/yourusername/EasySIMP.jl
```
...
julia --project=. examples/01_basic_cantilever.jl

# Beam with sliding (symmetry) boundary condition
julia --project=. examples/02_sliding_support.jl

# Beam under acceleration (body forces)
julia --project=. examples/03_with_acceleration.jl
```
...
julia --project=. examples/04_gripper_complex.jl
```
